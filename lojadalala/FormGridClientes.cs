...
namespace lojadalala
{
  public partial class FormGridClientes : Form
  {
    ...
    FormVendaSimples frmven2 = null;
    FormGridVenda gridVenda = null;
    PessoaFisica pf;
    ...
    private void butSair_Click(object sender, EventArgs e)
    {
      ...
      else if (gridVenda != null)
      {
        gridVenda.txtCodigoCliente.Focus();
      }
      else if (frmven2 != null)
      {
        frmven2.txtCodigoCliente.Focus();
      }
      this.Close();
    }
    ...
    private void dataGridViewPF_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
    {
      ...
      else
      {
        if (frm != null)
        {
          ...
          frm.btnDebitos.Enabled = true;
          frm.btnNovaVenda.Enabled = true;
          frm.btnPagamentos.Enabled = true;
          frm.butNovo.Focus();
        }
        else if (frmven != null)
        {
          frmven.radPessoaFisica.Checked = true;
          frmven.txtCodigoCliente.Text = Convert.ToString(dataGridViewPF.Rows[e.RowIndex].Cells[0].Value);
          frmven.tbNome.Text = dataGridViewPF.Rows[e.RowIndex].Cells[1].Value.ToString();
          frmven.tbApelido.Text = dataGridViewPF.Rows[e.RowIndex].Cells[2].Value.ToString();
          frmven.tbRgIe.Text = dataGridViewPF.Rows[e.RowIndex].Cells[3].Value.ToString();
          frmven.tbCpfCnpj.Text = dataGridViewPF.Rows[e.RowIndex].Cells[4].Value.ToString();
          frmven.tbEmail.Text = dataGridViewPF.Rows[e.RowIndex].Cells[14].Value.ToString();
          frmven.tbTelefone1.Text = dataGridViewPF.Rows[e.RowIndex].Cells[15].Value.ToString();
          frmven.tbTelefone2.Text = dataGridViewPF.Rows[e.RowIndex].Cells[17].Value.ToString();
          frmven.cbxSituacao.Text = dataGridViewPF.Rows[e.RowIndex].Cells[20].Value.ToString();
          frmven.butSalvar.Enabled = true;
          frmven.txtObservacao.Focus();
        }
        else if (gridVenda != null)
        {
          gridVenda.txtCodigoCliente.Text = frm.tbCodigoCliente.Text = Convert.ToString(dataGridViewPF.Rows[e.RowIndex].Cells[0].Value);
          gridVenda.lblNomeCliente.Text = dataGridViewPF.Rows[e.RowIndex].Cells[1].Value.ToString();
          gridVenda.btnPesquisar.Focus();
          //gridVenda.cbxSituacao.Focus();
        }
        else if (frmven2 != null)
        {
          frmven2.txtCodigoCliente.Text = Convert.ToString(dataGridViewPF.Rows[e.RowIndex].Cells[0].Value);
          frmven2.lblNomeCliente.Text = dataGridViewPF.Rows[e.RowIndex].Cells[1].Value.ToString();
    ...
    private void dataGridViewPJ_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
    {
      ...
      else
      {
        ...
        {
          frmven.radPessoaJuridica.Checked = true;
          frmven.txtCodigoCliente.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[0].Value.ToString();
          frmven.tbNome.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[1].Value.ToString();
          frmven.tbApelido.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[2].Value.ToString();
          frmven.tbRgIe.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[3].Value.ToString();
          frmven.tbCpfCnpj.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[4].Value.ToString();
          frmven.tbEmail.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[11].Value.ToString();
          frmven.tbTelefone1.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[12].Value.ToString();
          frmven.tbTelefone2.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[14].Value.ToString();
          frmven.cbxSituacao.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[17].Value.ToString();
          frmven.butSalvar.Enabled = true;
          frmven.txtObservacao.Focus();
        }
        else if (gridVenda != null)
        {
          gridVenda.txtCodigoCliente.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[0].Value.ToString();
          gridVenda.lblNomeCliente.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[1].Value.ToString();
          gridVenda.btnPesquisar.Focus();
          //gridVenda.cbxSituacao.Focus();
        }
        else if (frmven2 != null)
        {
          frmven2.txtCodigoCliente.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[0].Value.ToString();
          frmven2.lblNomeCliente.Text = dataGridViewPJ.Rows[e.RowIndex].Cells[1].Value.ToString();
          frmven2.txtCodProduto.Focus();
        }
        this.Dispose();
      }
    ...
    private void dataGridViewPF_KeyDown(object sender, KeyEventArgs e)
    {
      if (e.KeyCode == Keys.Enter)
      {
        ...
        int i = linhaAtual.Index;
        {
          ...
          {
            frmven.radPessoaFisica.Checked = true;
            frmven.txtCodigoCliente.Text = dataGridViewPF.Rows[i].Cells[0].Value.ToString();
            frmven.tbNome.Text = dataGridViewPF.Rows[i].Cells[1].Value.ToString();
            frmven.tbApelido.Text = dataGridViewPF.Rows[i].Cells[2].Value.ToString();
            frmven.tbRgIe.Text = dataGridViewPF.Rows[i].Cells[3].Value.ToString();
            frmven.tbCpfCnpj.Text = dataGridViewPF.Rows[i].Cells[4].Value.ToString();
            frmven.tbEmail.Text = dataGridViewPF.Rows[i].Cells[14].Value.ToString();
            frmven.tbTelefone1.Text = dataGridViewPF.Rows[i].Cells[15].Value.ToString();
            frmven.tbTelefone2.Text = dataGridViewPF.Rows[i].Cells[17].Value.ToString();
            frmven.cbxSituacao.Text = dataGridViewPF.Rows[i].Cells[20].Value.ToString();
            frmven.butSalvar.Enabled = true;
            frmven.txtObservacao.Focus();
          }
          else if (gridVenda != null)
          {
            gridVenda.txtCodigoCliente.Text = dataGridViewPF.Rows[i].Cells[0].Value.ToString();
            gridVenda.lblNomeCliente.Text = dataGridViewPF.Rows[i].Cells[1].Value.ToString();
            gridVenda.btnPesquisar.Focus();
            //gridVenda.cbxSituacao.Focus();
          }
          else if (frmven2 != null)
          {
            frmven2.txtCodigoCliente.Text = dataGridViewPF.Rows[i].Cells[0].Value.ToString();
            frmven2.lblNomeCliente.Text = dataGridViewPF.Rows[i].Cells[1].Value.ToString();
            frmven2.txtCodProduto.Focus();
          }
          this.Dispose();
        }
    ...
    private void dataGridViewPJ_KeyDown(object sender, KeyEventArgs e)
    {
      if (e.KeyCode == Keys.Enter)
      {
        ...
        {
          frmven.radPessoaJuridica.Checked = true;
          frmven.txtCodigoCliente.Text = dataGridViewPJ.Rows[i].Cells[0].Value.ToString();
          frmven.tbNome.Text = dataGridViewPJ.Rows[i].Cells[1].Value.ToString();
          frmven.tbApelido.Text = dataGridViewPJ.Rows[i].Cells[2].Value.ToString();
          frmven.tbRgIe.Text = dataGridViewPJ.Rows[i].Cells[3].Value.ToString();
          frmven.tbCpfCnpj.Text = dataGridViewPJ.Rows[i].Cells[4].Value.ToString();
          frmven.tbEmail.Text = dataGridViewPJ.Rows[i].Cells[11].Value.ToString();
          frmven.tbTelefone1.Text = dataGridViewPJ.Rows[i].Cells[12].Value.ToString();
          frmven.tbTelefone2.Text = dataGridViewPJ.Rows[i].Cells[14].Value.ToString();
          frmven.cbxSituacao.Text = dataGridViewPJ.Rows[i].Cells[17].Value.ToString();
          frmven.butSalvar.Enabled = true;
          frmven.txtObservacao.Focus();
        }
        else if (gridVenda != null)
        {
          gridVenda.txtCodigoCliente.Text = dataGridViewPJ.Rows[i].Cells[0].Value.ToString();
          gridVenda.lblNomeCliente.Text = dataGridViewPJ.Rows[i].Cells[1].Value.ToString();
          gridVenda.btnPesquisar.Focus();
          //gridVenda.cbxSituacao.Focus();
        }
        else if (frmven2 != null)
        {
          frmven2.txtCodigoCliente.Text = dataGridViewPJ.Rows[i].Cells[0].Value.ToString();
          frmven2.lblNomeCliente.Text = dataGridViewPJ.Rows[i].Cells[1].Value.ToString();
          frmven2.txtCodProduto.Focus();
        }
        this.Dispose();
      }
