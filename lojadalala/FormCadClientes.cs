...
namespace lojadalala
{
  public partial class FormCadClientes : Form
  {
    ...
    public FormCadClientes(FormPrincipal parent)
    {
      ...
      usuario = parent.lblUsuario.Text;
    ...
    private void radPessoaFisica_CheckedChanged(object sender, EventArgs e)
    {
      ...
      lblRamal1.Visible = false;
      lblRamal2.Visible = false;
      tbRamal1.Visible = false;
      tbRamal2.Visible = false;
    ...
    {
      if (!Char.IsLetterOrDigit(e.KeyChar) && e.KeyChar != (char)8 && e.KeyChar != '.' && e.KeyChar != '-')
      {
        e.Handled = true;
      }
    }
    ...
    {
      /*FormVendas frmv = new FormVendas((FormPrincipal)this.ParentForm);
      frmv.UsuarioAtual = frmp.lblUsuario.Text;
      frmv.Show();
      frmv.butNovo.PerformClick();
      frmv.txtCodigoCliente.Text = tbCodigoCliente.Text;
      frmv.txtCodigoCliente.Focus();
      frmv.txtObservacao.Focus();
      this.Dispose();      
       */
      FormTipoVenda ven = new FormTipoVenda(this);
      ven.Show();
    }

    private void btnDebitos_Click(object sender, EventArgs e)
    {
      //FormDebitosCliente frmDeb = new FormDebitosCliente((FormPrincipal)this.ParentForm);
      FormDebitosCliente frmDeb = new FormDebitosCliente();
      frmDeb.MdiParent = this.ParentForm;
      frmDeb.Text = "Débitos - Cliente: " + tbNome.Text;
      frmDeb.idcliente = Convert.ToInt32(tbCodigoCliente.Text);
      frmDeb.usuario = usuario;
      frmDeb.Show();
    }

    private void btnPagamentos_Click(object sender, EventArgs e)
    {
      FormPagtosCliente frmPag = new FormPagtosCliente();
      frmPag.MdiParent = this.ParentForm;
      frmPag.Text = "Pagamentos - Cliente: " + tbNome.Text;
      frmPag.codigoCliente = Convert.ToInt32(tbCodigoCliente.Text);
      frmPag.Show();
    }
    ...
    private void FormCadClientes_KeyPress(object sender, KeyPressEventArgs e)
    {
